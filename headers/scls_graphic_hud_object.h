...
namespace scls {
    ...
    public:
        ...
        inline glm::vec4 absolute_border_width() {
            ...
            return (border_width() * glm::vec4(1.0)) / glm::vec4(absolute_scale_for_calcul[1], absolute_scale_for_calcul[0], absolute_scale_for_calcul[1], absolute_scale_for_calcul[0]);
        };
