...
namespace scls_documentalist_gui {
    ...
    void SCLS_Documentalist_GUI::load_create_pattern_body() {
        ...
        a_create_pattern_body->move_right_of_parent(0.025);
        ...
        a_create_pattern_name->set_height_in_scale(scls::Fraction(7, 20));
        a_create_pattern_name->set_width_in_scale(scls::Fraction(1, 10));
        a_create_pattern_name->set_x_in_scale(scls::Fraction(2, 5));
        ...
        a_create_pattern_name_title->set_x_in_scale(scls::Fraction(-2, 5));
        ...
        a_create_pattern_path->set_x_in_scale(scls::Fraction(-2, 5));
        a_create_pattern_path->set_y_in_scale(scls::Fraction(11, 20));
        a_create_pattern_path->set_height_in_scale(scls::Fraction(1, 10));
        ...
        a_create_pattern_path_change->set_x_in_scale(scls::Fraction(2, 5));
        a_create_pattern_path_change->set_y_in_scale(scls::Fraction(3, 10));
        ...
        a_create_pattern_path_title->set_x_in_scale(scls::Fraction(-2, 5));
        ...
        a_create_pattern_validation->set_x_in_scale(scls::Fraction(-2, 5));
        a_create_pattern_validation->set_y_in_scale(scls::Fraction(-4, 5));
    ...
    void SCLS_Documentalist_GUI::load_pattern_footer() {
        ...
        a_pattern_footer->set_x_in_scale(0.0);
        ...
        a_pattern_footer->move_bottom_of_parent();
        ...
        a_pattern_footer_create_file_pattern->move_left_of_parent();
        a_pattern_footer_create_file_pattern->move_top_of_parent();
        ...
        a_pattern_footer_save_all->move_left_of_parent();
        a_pattern_footer_save_all->move_bottom_of_parent();
    }
    ...
    void SCLS_Documentalist_GUI::load_pattern_main_body() {
        ...
        a_pattern_main_body->move_right_of_parent(0.025);
        ...
        a_pattern_main_body_title->move_top_of_parent();
    }
    ...
    void SCLS_Documentalist_GUI::load_pattern_navigation() {
        ...
        a_pattern_navigation->move_left_of_parent();
    }
    ...
    void SCLS_Documentalist_GUI::load_welcome_footer() {
        ...
        a_welcome_footer_create_pattern->move_left_of_parent();
        a_welcome_footer_create_pattern->move_top_of_parent();
        ...
        a_welcome_footer_open_pattern->move_left_of_parent();
